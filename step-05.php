...
<head>
<meta charset="UTF-8">
<title>External CSS | BrickTown</title>
  ...
  <div class="siimple-grid-row">
    <div class="siimple-grid-col siimple-grid-col--12">
		<div class="siimple-box">
		  <div class="siimple-box-title">Disable External CSS</div>
...
<script>
document.getElementById("trick456").innerHTML = random;
verify();
function verify(){
	if(document.getElementById("guess").value === random.toString()){
		 document.getElementById("content").innerHTML = "Current guess is: <span class=\"siimple-tag siimple-tag--green\">" + document.getElementById("guess").value.toString() + "</span><br><br><div class=\"siimple-btn siimple-btn--blue\"><a href=\"step-06.php\">Next</a></div>";
	 }else{
